...
class LocationResultScreen extends StatefulWidget {
  dynamic data;
  LocationResultScreen({super.key,this.data});
                ...
                children: [
                  ...
                  StreamBuilder(
                    ...
                    builder: (BuildContext context,
                      ...
                      final locationFilter = snapshot.data!.docs
                          .where((document) => document['address']['city'] == widget.data['city'])
                          .toList();
                      ...
                      return SizedBox(
                        ...
                        child: GridView.builder(
                          ...
                          itemCount: locationFilter.length,
                          itemBuilder: (context, index) {
                            final document = locationFilter[index];
