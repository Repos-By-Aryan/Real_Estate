                          ...
                          itemBuilder: (context, index) {
                            ...
                            if(propertyType['rent']){
                              return Container(
                                ...
                                constraints: BoxConstraints.expand(height: 160,width: screenWidth*0.82),
                                decoration: BoxDecoration(
                                          ...
                                          child: CachedNetworkImage(
                                            ...
                                            imageBuilder: (context, imageProvider) => InkWell(
                                              ...
                                              child: Container(
                                                ...
                                                height: 160, // Add height constraint
                                                decoration: BoxDecoration(
                                                  image: DecorationImage(
                                                    image: imageProvider,
                                                    fit: BoxFit.cover,
                            ...
                            switch(selectedCard) {
                              case 0:
                                return Container(
                                  ...
                                  constraints: BoxConstraints.expand(height: 300,width: screenWidth*0.4),
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(20),
                                    color: const Color(0xffF5F4F8),
                                  ),
                                  child: Column(
                                    children: [
                                          ...
                                          Padding(
                                            ...
                                            child: CachedNetworkImage(
                                              ...
                                              imageBuilder: (context, imageProvider) => InkWell(
                                                ...
                                                child: Container(
                                                  width: double.infinity,
                                                  height: 170, // Add height constraint
                                                  decoration: BoxDecoration(
                                                    image: DecorationImage(
                                                      image: imageProvider,
                                                      fit: BoxFit.cover,
                                      ...
                                      Container(
                                        width: double.infinity,// Wrap the Text widget with Expanded
                                        child: Padding(
